        ...
        return createLayout({
            ...
            extendMethods: {
                ...
                getShape: function getShape() {
                    ...
                    var rect = void 0;
                    if (content) {
                        rect = [[content.offsetLeft, content.offsetTop], [content.offsetLeft + content.offsetWidth, content.offsetTop + content.offsetHeight]];
                    } else {
                        var size = this._size || [0, 0];
                        rect = [[0, 0], [size[0], size[1]]];
                    }

                    return new (_api2.default.getAPI().shape.Rectangle)(new (_api2.default.getAPI().geometry.pixel.Rectangle)(rect));
                },
