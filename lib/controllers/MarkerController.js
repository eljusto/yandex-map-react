...
var MarkerController = function () {
    ...
    _createClass(MarkerController, [{
        ...
        value: function setClusterBalloonState(state, clusterer) {
            if (state === 'opened') {
                var geoObjectState = clusterer.getObjectState(this._marker);
        ...
        key: 'destroyOnClusterer',
        value: function destroyOnClusterer(clusterer) {
            this.events.removeAll();
