...
var YandexMap = function (_Component) {
    ...
    _createClass(YandexMap, [{
        ...
        value: function _onAPILoad(namespace) {
            ...
            this._controller.createMap(_reactDom2.default.findDOMNode(this.mapElement), _extends({}, this.props.state, {
                center: this.props.center,
                bounds: this.props.bounds,
                zoom: this.props.zoom,
                minZoom: this.props.minZoom,
                maxZoom: this.props.maxZoom
            }), _extends({}, this.props.options), this.props.useClusterer, this.props.clustererOptions);
...
YandexMap.propTypes = {
    ...
    useClusterer: _react.PropTypes.bool,
    clustererOptions: _react.PropTypes.object,
